...
<body>
    ...
    <table cellpadding="3" cellspacing="0" style="width: 100%;text-align:right;">
        <tr>
            <td>
                <img src="https://exalogic-store.s3.us-east-2.amazonaws.com/tasc/templates/TASC_LabourServices/AIQU_Logo.png" width="100" alt="Logo">
            </td>
        </tr>
    </table>
...
<tr>
	<td style="font-size:14px;font-family: 'TimesNewRoman';font-weight:normal;">You will be working for AIQU, a part of <b>{CompanyName}</b> and you will be deputed with our client
...
<tr>
    <td style="font-size:14px;font-family: 'TimesNewRoman';font-weight:normal;">AIQU will be responsible to provide you with “employee care”, visa and
            payroll services. Your day to day responsibilities will be assigned and
            supervised by the client directly. You will be required to follow all
            rules and regulations of the client. Your employment will be based on the
            following terms and conditions in addition to those stated in the labor
            contract.</td>
</tr>
<tr>
    <td style="width:100%">
        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
            ...
            <strong>{Entitlement_Unit}</strong> calendar days paid leave as per
            UAE labor law.</td>
                                </tr>
                                <tr>
                                    <td valign="top">d.</td>
                    ...
                    <td style="width:97%"><b>Notice Period and Termination:</b><br /><br />
                        <table cellpadding="0" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                <tr>
                                    <td valign="top" style="width: 3%;">a.</td>
                                    <td style="width: 97%;">During the probation period, AIQU may terminate your services with or
            without cause by giving <b>{Notice_Period_prb}</b> notice. After probation period; AIQU
            may terminate your services by giving
            <strong>{Notice_Period} days’</strong> notice.</td>
                                </tr>
                                <tr>
                                    <td valign="top">b.</td>
                                    <td>You may terminate your services with AIQU by giving
            <strong>{Notice_Period} days’</strong> notice applicable during and
            after probation period. In case you terminate your employment without
            giving notice, AIQU may in certain cases at its own discretion accept
            equivalent salary in lieu of notice period.</td>
                                </tr>
                                <tr>
                                    <td valign="top">c.</td>
                                    <td>In case if AIQU is required to incur certain expenses to facilitate
            your training and you are also desirous of undergoing such training to
            enhance your career growth, if you resign or terminate your employment
            with AIQU in less than one year, AIQU will recover training and
            onboarding expenses from your full and final settlement. This will be
            limited to one month’s salary.</td>
                                </tr>
                                <tr>
                                    <td valign="top">d.</td>
                                    <td>In case of any allegation of misconduct, fraud, gross negligence or
            any criminal act, or act of disobedience, insobriety, insubordination,
            or in case it is found that any information or academic qualification
            provided by you is false or misleading, your employment will be
            terminated with immediate effect by AIQU, in writing, without notice
            or end of service benefits.</td>
                                </tr>
                                <tr>
                                    <td valign="top">e.</td>
                                    <td>If you absent yourself for 7 consecutive or 20 non-consecutive days
            without prior written permission; your employment shall be terminated
            without any notice.</td>
                                </tr>
                                <tr>
                                    <td valign="top">f.</td>
                                    <td>You must return all materials and properties including but not limited
            to documents, notes, memoranda, records, list of customers, suppliers
            and employees, correspondences, documents, computer and other CDs,
            data, discs codes, designs and drawings, and other documents
            whatsoever (whether made or created by you) belonging to or related to
            the client and AIQU on your resignation and termination or pay damages
            in lieu thereof.</td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    ...
                    <td style="width:97%"><b>Leave:</b><br /><br />
                        <table cellpadding="0" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                <tr>
                                    <td valign="top" style="width: 100%;">Any leave including paid leave, which are accumulated and not utilized can
            be encashed as per policy. In case of any sick leave availed for more than
            1 day, you will need to provide a medical certificate by the relevant
                    ...
                    <td style="width:97%"><b>General Conditions:</b><br /><br />
                        <table cellpadding="0" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">b.</td>
                                    <td>This offer is subject to successful processing of your visa and legal entry permits by the UAE Ministry of Labor and immigration authorities. This offer is also subject to obtaining a medical fitness certificate, background screening, police clearance certificate issued from your country of residence or nationality. This offer letter is further subject to a successful CID clearance in case the same is requested by the Client. In case any of these requirements are not met or the entry permit or the visa or CDI clearance is rejected for any reason, whatsoever, this offer letter will be construed as null and void. This offer letter is also subject to receipt of at least 2 satisfactory reference checks, the verification of the educational certificate and credentials submitted to AIQU and may be revoked if the aforesaid is not received and all expenses incurred by AIQU will be payable by you.</td>
                                </tr>
                                <tr>
                                    <td valign="top">c.</td>
                                    <td>The ‘Offer of Employment’ and this ‘Offer letter’ are subject to AIQU being in receipt of an offer for services from the client. Should the offer be withdrawn at any point by the client and it is deemed as beyond the control of AIQU, then AIQU reserves the right to withdraw the offer to the candidate at any time prior to the onboarding date with no reason offered. No financial recompense will be paid by AIQU to you.</td>
                                </tr>
                                <tr>
                                    <td valign="top">d.</td>
                                    <td>In the event of your appearance at, or summons to appear at any criminal court, or in the event of any criminal conviction or civil order being made against you, either during the period of your employment with AIQU, or prior to joining AIQU you must inform AIQU as soon as possible and must on request give full details to AIQU.</td>
                                </tr>
                                <tr>
                                    <td valign="top">e.</td>
                                    <td>You accept and acknowledge that your personal information including but not limited to your passport, visa, etc. (“Personal information”) shall be stored by AIQU on cloud-based business application and you hereby agree that AIQU shall not be liable in the event that such Personal Information is retrieved, accessed, distributed or used with or without authorization by AIQU. You hereby fully indemnify and hold AIQU harmless for any liability arising from any and all claims, requests, debts, expenses, losses and actions in relation to any authorized or unauthorized access, retrieval, distribution or usage of your Personal Information.</td>
                                </tr>
                                <tr>
                                    <td valign="top">f.</td>
                                    <td>It is recommended that you take travel insurance for yourself (if you are currently outside UAE) or continue your existing insurance (if you are inside UAE) until your insurance is applied by AIQU.</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
            ...
            information related to AIQU and its client confidential and private and
            not to communicate the same to any person including without limitation,
            information regarding the business and finances of the client or of AIQU.
            A separate non-disclosure agreement will be signed by you in this regard.
            This confidentiality clause will be binding on you even after your
            employment ends with AIQU for any reason whatsoever.</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
            ...
            employment in the field of a competitor in the United Arab Emirates for
            two years, according to Article 127 of the law from the date of
                ...
                <tr>
                    ...
                    <td style="width:97%"><b>Outside Occupation:</b><br /><br />
                        <table cellpadding="0" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                <tr>
                                    <td valign="top" style="width: 100%;">You are prohibited from working for any other employers, paid or unpaid,
            without a written consent of AIQU during your employment with AIQU.</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
	...
	<td style="width: 100%;">
        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
            ...
            letter.</td>
                                ...
                                <tr>
                                    <td valign="top">d.</td>
                                    <td>I agree to abide by all the terms and conditions specified in this
            offer letter and acknowledge that these conditions are in addition to
            those generally specified in the UAE Labor contract</td>
                                </tr>
                                <tr>
                                    <td valign="top">e.</td>
