                                        ...
                                        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 96%;">The above salary is guaranteed upon the successful completion of 218 orders per month.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">b.</td>
                                                    <td>You are eligible to receive AED 7.5 for each delivery over and above 218 deliveries.</td>
                                                </tr>
                                                <tr>
