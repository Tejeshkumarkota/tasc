...
<tr>
	<td style="font-size:14px;font-family: 'TimesNewRoman';font-weight:normal;">You have been selected as <b>{PositionDescription}</b> and we’re delighted to extend this offer to you! This letter contains terms and conditions of your potential employment.</td>
</tr>
<tr>
...
<tr>
	<td>
		<table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';text-align:left;">
			<!-- <tbody> -->
                <tr><td style="width:20%;text-align:left;">Expected Date of Joining</td><td style="width: 80%;">: {Expected Date}</td></tr>
                <tr><td style="width: 10%;text-align:left;">Visa Sponsor</td><td style="width: 90%;">: FUTURE MILEZ (FUTURE MILEZ)</td></tr>
...
<tr>
	<td style="font-size:14px;font-family: 'TimesNewRoman';font-weight:normal;">
		<strong style="text-decoration: underline;">Work Location: - </strong>You will be outsourced to work for {ClientName}, client of FUTURE MILEZ DMCC. Future Milez DMCC can transfer you to other clients or locations based on similar terms and conditions.
	</td>
</tr>
<tr>
	<td style="font-size:14px;font-family: 'TimesNewRoman';font-weight:normal;">
		<strong style="text-decoration: underline;">Probation: </strong> 6 month(s)
	</td>
</tr>
<tr>
	<td style="font-weight: bold;font-size:14px;font-family: 'TimesNewRoman';">
                    ...
                    <td style="width:100%">
                        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                ...
                                <tr>
                                    <td>e. Annual Leave Encashment</td>
                                    <td>: AED 0</td>
                                </tr>
                                <tr>
                                    <td><strong>f. Total Salary</strong></td>
                                        ...
                                        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 96%;">You will be working under a variable salary model and you are eligible to receive the above-mentioned salary upon completing 224 deliveries monthly.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">b.</td>
                                                    <td>You will be paid AED 7.5 per delivery over and above 224 deliveries.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">c.</td>
                                                    <td>All other components calculated are covered under the per-order remuneration.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">d.</td>
                                                    <td>Company will provide you a sim card for local usage only with a monthly rental of AED 100 which consist of 7.5 GB data and 1000 local minutes. Any usage over and above the permitted use will be deducted from your per-order remuneration calculated on a monthly basis.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">e.</td>
                                                    <td>Company will support you to lease the delivery vehicle with a maximum monthly rental of AED 525. This amount will be deducted in a monthly fashion from your per-order remuneration monthly.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">f.</td>
                                                    <td>Fuel expense is not provided by the company.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">g.</td>
                                                    <td>Any expense incurred on the vehicle will be recovered from per-order remuneration calculated on a monthly basis which includes but is not limited to damage caused by you to the vehicle, RTA fine, penalties, and Salik, as applicable.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">h.</td>
                                                    <td>Your Annual leave pay will be part of your Monthly gross pay mentioned above.</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">i.</td>
                                                    <td>If you have previously worked with Talabat please confirm Yes/No_____________</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">j.</td>
                                                    <td>If you did work with Talabat previously, kindly confirm whether you have been blacklisted by Talabat Yes/No ___________</td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">k.</td>
                                                    <td>If you have not been true to the information provided in points I and J, you will be responsible to reimburse the entire expenditure invested by the company for your recruitment, which includes but is not limited to Visa expenses, and medical insurance as applicable. Kindly sign here with your acknowledgement _________________________</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                    ...
                    <td style="width:100%">
                        <table cellpadding="3" cellspacing="0" style="width: 100%;font-size:14px;font-family: 'TimesNewRoman';">
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">c)</td>
                                    <td>FUTURE MILEZ may terminate services by giving <b>{Notice_Period} days’</b> notice</td>
                                </tr>
                                <tr>
                                    <td valign="top">d)</td>
...
<tr>
	<td style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">
        You are expected to comply with all instructions with all instructions given by the Company and its client. Please note that failure to comply with the instructions and more specifically with the requirements below shall result in deduction of penalties from your monthly remuneration.   You consent to such deductions from your monthly remuneration and agree not to initiate claims against the Company for any deductions made. The fines mentioned hereunder are an approximate and genuine pre-estimate of the damage which will be incurred by the Company in case of your breach
	</td>
</tr>
<tr>
	<td>
			...
			<tbody>
                <tr valign="top">
                    <td style="text-align:center;">
                        <strong> Delivery box fixing charges </strong>
                    </td>
                    <td>
                        Employee will acknowledge its responsibility in case of the loss
                        or the damage of the storage boxes due to the negligence, misuse,
                        omission, and act of its Operators. A penalty of AED 5,000 per box
                        in addition to the installation and permits costs shall be imposed
                        on you in the event of misusing the box by the Employee which
                        resulted in partial or total destruction, loss or damage
                    </td>
                    <td>
                        5000+Plus any Installation Charges
                    </td>
                </tr>
                <tr valign="top">
                    <td style="text-align:center;">
                        <strong> Exit penalty if Employee leaves before 6 months </strong>
                    </td>
                    <td>
                        If Employee leaves before six months from the date of being
                        assigned the services under this Agreement, then the First Party
                        shall be liable for the payment of a penalty equal to AED 850 for
                        each Operator leaves before the said period (“Early Exit Penalty”)
                    </td>
                    <td>870</td>
                </tr>
			</tbody>
...
<tr>
	<td style="font-size: 14px;font-family: 'TimesNewRoman';">
		<strong>Exit Penalty Charges: - </strong>
	</td>
</tr>
<tr>
	<td>
		<table cellpadding="3" cellspacing="0" border="1" style="width:100%;margin-bottom:20px;font-size:14px;font-family: 'TimesNewRoman';">
			<thead>
				<tr>
					...
					<th style="font-weight:bold;text-align:center;">  Equipment </th>
					<th style="font-weight:bold;text-align:center;">
                        Cost Per Unit
					</th>
				</tr>
			...
			<tbody>
              ...
              ">
                        ...
                        <td>Front Opening Delivery Bag</td>
                        <td style="
              ...
              ">
                        ...
                        <td>Top Opening Delivery Bag</td>
                        <td style="
...
<tr>
	<td style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">In the event that the Company has to bear any fines on account of any actions/omissions by you as mentioned above and such fines as calculated on a monthly/quarterly basis exceed your monthly remuneration, the Company shall have the right to claim these from you as damages and you agree to reimburse the Company with all losses incurred by it on your account.</td>
</tr>
<tr>
	<td style="font-size: 14px;font-family: 'TimesNewRoman';font-weight:normal;">
